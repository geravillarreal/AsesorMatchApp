...
class ProjectAssignmentTests {
	...
	void cannotAssignSecondProjectIfOneInProgress() {
		...
		boolean hasMatch = matchRepository.existsByStudentIdAndAdvisorIdAndStatus(student.getId(), advisor.getId(),
				MatchStatus.ACCEPTED);
		boolean hasActive = !projectRepository
				.findByStudentAndAdvisorAndStatus(student, advisor, ProjectStatus.IN_PROGRESS).isEmpty();
