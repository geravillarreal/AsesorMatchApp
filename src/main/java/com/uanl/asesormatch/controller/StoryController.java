...
public class StoryController {
	...
	@PostMapping("/add")
	public String add(@AuthenticationPrincipal OidcUser oidcUser, @RequestParam Long projectId,
		...
		if (!project.getStudent().getId().equals(user.getId())) {
			String msg = "The advisor added a story to your project (" + project.getTitle() + "): " + title + ".";
	...
	@PostMapping("/next")
	public String next(@AuthenticationPrincipal OidcUser oidcUser, @RequestParam Long storyId) {
		User user = userRepository.findByEmail(emailProvider.resolveEmail(oidcUser)).orElseThrow();
